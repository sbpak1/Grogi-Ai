...
export default function Sidebar({ onSelectSession, onNewChat, isCollapsed, onToggle, currentSessionId, sessions }: SidebarProps) {
    ...
    return (
        <aside className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
                ...
                <div className="sessionList">
                    {sessions.map((s) => (
                        ...
                        >
                            ...
                            {!isCollapsed && <span className="sessionTitle">{s.title || '새 대화'}</span>}
                        </button>
                    ))}
                </div>
            </div>
            ...
            <div className="sidebarBottom">
                <button className="sidebarIconBtn" title="설정">
